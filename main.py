...
<div><h1>🤖 GridrunnerAItrader</h1><div class="sub"><span class="dot" id="dot"></span> <span id="status-text">Stopped</span></div></div>
<button class="btn" onclick="toggleConfig()" id="gear-btn" style="font-size:16px;padding:6px 10px" title="Toggle Config">⚙</button>
